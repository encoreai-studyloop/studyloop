...
<body>
                                ...
                                <table id="example23" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>${userDto.getPrime()}</td>
                                            <td>${userDto.getRegdate()}</td>
                                            <td><a href="javascript:void(0)" class="text-inverse p-r-10" data-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a> <a href="javascript:deleteUser(${userDto.getId()})" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a></td>             
                                        </tr>
                                      </c:forEach>  
                                    </tbody>
                                </table>
    ...
    function deleteUser(id){
    	if(confirm("해당 회원을 삭제처리 하시겠습니까?") == true)
    		location = "deleteUserbyadmin.do?id="+id
    }
    </script>
    <!--Style Switcher -->
