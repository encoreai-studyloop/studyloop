...
<body>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="table table-striped">
                                    ...
                                    <tbody>
                                   <c:forEach var="ADto" items="${ADtoList}">
                                        <tr>
                                        	<td>${ADto.getId()}</td>
                                            <td>${ADto.getReporter_nick()}</td>
                                            <td>${ADto.getArticle_title()}</td>
                                            <td>${ADto.getContent()}</td>
                                            <td>${ADto.getRepcat_name() }</td>
                                            <td>${ADto.getStudy_title()}</td>
                                            <td>${ADto.getTime()}</td>
                                            <td><a href="javascript:deleteConfirm(${ADto.getId()})" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a></td> 
                                        </tr>
                               		</c:forEach>
                                    </tbody>
	...
	function deleteConfirm(sid){
		if(confirm("정말  삭제하시겠습니까?") == true){
			location = "deleteReportedArticlebyadmin.do?sid="+sid;
		}
	}
	</script>
