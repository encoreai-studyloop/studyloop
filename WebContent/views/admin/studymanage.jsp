...
<body>
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="table table-striped">
                                   ...
                                   <c:forEach var="studyDto" items="${studyDtoList}">
                                        <tr>
                                            <td>${studyDto.getId()}</td>
                                            <td><a href="view.do?sid=${studyDto.getId()}">${studyDto.getTitle()}</a></td>
                                            <td>${studyDto.getIntro()}</td>
                                            <td>${studyDto.getUser_name()}</td>
                                            <td><a href="javascript:deleteConfirm(${studyDto.getId()})" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a></td> 
                                        </tr>
                               		</c:forEach>
                                    </tbody>
                                </table>
	...
	function deleteConfirm(sid){
		if(confirm("정말  삭제하시겠습니까?") == true){
			location = "deleteStudybyadmin.do?sid="+sid;
		}
	}
	</script>
