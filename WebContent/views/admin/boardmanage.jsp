...
<body>
                                ...
                                <table id="example23" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="view.do?sid=${boardDto.getStudy_id()}">${boardDto.getStudy_name()}</a></td>
                                            <td><a href="boardcontent.do?bid=${boardDto.getId()}">${boardDto.getTitle()}</a></td>
                                            <td>${boardDto.getLogtime()}</td>
                                            <td><a href="javascript:void(0)" class="text-inverse p-r-10" data-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a> <a href="javascript:deleteArticle(${boardDto.getId()}, ${boardDto.getStudy_id()})" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a></td>             
                                        </tr>
                                      </c:forEach>  
                                    </tbody>
                                </table>
    ...
    function deleteArticle(id, sid){
    	if(confirm("해당 게시글을 삭제처리 하시겠습니까?") == true)
    		location = "deleteArticlebyadmin.do?id="+id+"&sid="+sid
    }
    </script>
    <!--Style Switcher -->
