...
<body>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="table table-striped">
                                    ...
                                    <tbody>
                                   <c:forEach var="studyRDto" items="${studyRDtoList}" >
                                        <tr>
                                        	<td>${studyRDto.getId()}  </td>
                                            <td>${studyRDto.getReporter_nick()}</td>
                                            <td>${studyRDto.getStudy_title()}</td>
                                            <td>${studyRDto.getSuspect_nick()}</td>
                                            <td>${studyRDto.getContent()}</td>
                                            <td>${studyRDto.getRepcat_name()}</td>
                                            <td>${studyRDto.getTime()}</td>
                                            <td><a href="javascript:deleteConfirm(${studyRDto.getId()})" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a></td> 
                                        </tr>
                               		</c:forEach>
                                    </tbody>
                                </table>
	...
	function deleteConfirm(sid){
		if(confirm("정말  삭제하시겠습니까?") == true){
			location = "deleteReportedStudybyadmin.do?sid="+sid;
		}
	}
	</script>
