...
<c:set var="str_attendee" value="현재 참석자 정보 (premium 기능)"/>
...
<!-- button -->
<c:set var="btn_chat" value="카카오톡 오픈채팅 연결하기"/>
<c:set var="btn_apply" value="내 정보 입력 수정"/>
...
<!-- table str -->
<c:set var="str_saveguide" value="※ 스터디 신청 시 미리 입력해놓은 정보를 '${btn_savedinfo}' 버튼으로 불러올 수 있습니다."/>
