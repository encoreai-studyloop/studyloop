            ...
            <div class="">
			 <a href="javascript:void(0)" onclick="location='main.do'" class="text-center db m-b-40"><img src="../../studyloop/views/search/images/logo.png" alt="Home" style="width:50%; height: 50%" /></a>
                   ...
                   <div class="form-group">
                        ...
                        <div class="form-group">
                              <div class="input-group">
                                   <input type="text" name="nick" class="form-control" placeholder="닉네임">
  						...
  						<div class="form-group">
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            <input type="password" data-toggle="validator" data-minlength="6" class="form-control" id="inputPassword2" placeholder="Password" name="passwd" required>
                    ...
                    <fieldset>
                    	<div class="input-group">
                    	<input type="text" name="birth" class="form-control" id="datepicker-autoclose" placeholder="생년월일"><span class="input-group-addon"><i class="icon-calender"></i></span>
                        </div>
