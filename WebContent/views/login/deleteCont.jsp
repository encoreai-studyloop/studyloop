...
<body>
    ...
    <section id="wrapper" class="step-register">
        ...
        <div class="register-box">
            <div class="">
                <a href="javascript:void(0)" class="text-center db m-b-40"><img src="../../studyloop/default/plugins/images/eliteadmin-logo-dark.png" alt="Home" />	
                    <br/><img src="../../studyloop/default/plugins/images/eliteadmin-text-dark.png" alt="Home" /></a>
                    ...
                    <fieldset>
                        ...
                        <input type="button" id="verfinish" name="next" class="next action-button" value="탈퇴" onclick="delConfirm(${userDto.getId()})"/>
                    </fieldset>
                    <fieldset>                   	
                   ...
                   <div class="form-group">
                    ...
                    <fieldset>
                    	<div class="input-group">
                    	<input type="text" name="birth" class="form-control" id="datepicker-autoclose" placeholder="생년월일" value="${userDto.getBirth()}"><span class="input-group-addon"><i class="icon-calender"></i></span>
                        </div>
                        ...
                        <input type="text" id="zip" name="zipcode" placeholder="우편번호"/>
