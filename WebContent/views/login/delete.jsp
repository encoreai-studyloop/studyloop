        ...
        <div class="register-box">
            <div class="">
                ...
                <form id="msform" name="submitform">
                    <!-- fieldsets -->
                    <fieldset>
                        <h2 class="fs-title">탈퇴를 위한 이메일 인증을 진행하세요</h2>
                        <input id="emailinput" type="text" name="email" placeholder="Email" value="${email}" readonly="readonly"/>
                        <input type="button" name="next" class="action-button" value="인증번호 전송" onclick="return delAuthProcess()" />         
                    </fieldset>
                </form>
                <div class="clear"></div>
            </div>
