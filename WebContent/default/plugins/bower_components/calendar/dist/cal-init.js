    ...
    CalendarApp.prototype.init = function() {
        ...
        $this.$calendarObj = $this.$calendar.fullCalendar({
            ...
            events: function (start, end, timezone, callback) {
                $.ajax({
                    url: "/studyloop/initcalendar.do",
                    type: "GET",
                    async:false,
                    datatype: 'json',
                    data: {calendarDate:$('#calendar').fullCalendar('getDate').format('YYYYMMDD'), study_id: $('#study_id').val()},
                    ...
                    success: function(data){
                        ...
                        $.each(json, function(i, obj) {
                            ...
                            events.push({id: obj.id, title: obj.content, start: obj.start_date, end: obj.end_date, className: [obj.classname], allDay:allday});
	                        ids.push(obj.id)
                        });
                        console.log(events)
